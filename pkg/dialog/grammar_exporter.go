...
func ExportGrammar(deckName string, g Grammar) error {
	...
	noteFields := map[string]string{
		"SentenceFront":         strings.ReplaceAll(g.SentenceFront, " ", ""),
		"SentenceBack":          strings.ReplaceAll(g.SentenceBack, " ", ""),
